                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <form class="d-flex" action="<?php echo e(route('admin.category.search')); ?>" method="GET">
                                    <input class="form-control me-1" type="search" placeholder="Buscar categoria" aria-label="Buscar" name="q" value="<?php echo e(request('q')); ?>">
...
<?php /**PATH /var/www/news/resources/views/layouts/admin/category/app.blade.php ENDPATH**/ ?>